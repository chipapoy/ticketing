...
const Modal_MaintenanceWindow = (props) => {
        ...
        <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={ () => { null } }>
          ...
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-full items-start md:justify-center md:p-4 text-center sm:items-start w-full md:max-w-none">
              ...
              >
                <Dialog.Panel className={`relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-auto`}>
...
export default Modal_MaintenanceWindow