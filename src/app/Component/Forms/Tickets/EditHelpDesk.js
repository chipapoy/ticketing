                ...
                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 mt-4">
                  ...
                  <div className="mx-5">
                    <Form_Item_dropdown2
                      ...
                      isRequired={true}
                      disableClear={true}
                      isReadOnly={(ticketDetails.active_org_id == 1 || ticketDetails.active_org_id == 2 || ticketDetails.active_org_id == 6) ? ticketDetails.status == "Closed" ? true : false : true}
                    ...
                    <Form_Item_dropdown2
                      ...
                      label={'Active Org'}
                      variant={'outlined'}
                      listOfItems={isOpen ? [activeOrg] : activeOrgArr}
                      isRequired={true}
                      disableClear={true}
                      isReadOnly={(ticketDetails.active_org_id == 1 || ticketDetails.active_org_id == 2 || ticketDetails.active_org_id == 6) ? ticketDetails.status == "Closed" ? true : false : true}
                      defaultSelection={isOpen}
                      getValueCallback={getSelectCallback}
                      selectedValue={activeOrg}
